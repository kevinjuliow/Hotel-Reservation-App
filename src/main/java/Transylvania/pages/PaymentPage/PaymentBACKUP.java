...
public class PaymentBACKUP extends JFrame {
    ...
    public PaymentBACKUP() {
        ...
        ImageIcon imageIconSideBar = new ImageIcon(Objects.requireNonNull(PaymentBACKUP.class.getClassLoader().getResource("assets/log-out-regular-240 (1).png")));
...
//        paymentMethodBox.setRenderer(new CustomRenderer());
    ...
    public static void main(String[] args) {
        PaymentBACKUP payment = new PaymentBACKUP();
