...
//    }
    ...
    public AdminPage(User userData) {
        ...
        //Logout Icon
        NoScalingIcon logoutImg = new NoScalingIcon(env.LoadImage("assets/log-out-regular-240 (1).png", 36, 36));
        JLabel logoutIcon = new JLabel(logoutImg);
        logoutIcon.setBounds(22, 40, 36, 36);
        mainPanel.add(logoutIcon);
        logoutIcon.addMouseListener(new env.CursorPointerStyle(logoutIcon));
        ...
        addImageBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int result = fileChooser.showOpenDialog(AdminPage.this);
        ...
        addBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JTextField standardPriceVal = (JTextField) env.FindComponents(standardPanel , "price");
                standardPrice = Integer.parseInt(standardPriceVal.getText());
                JTextField deluxePriceVal = (JTextField) env.FindComponents(deluxePanel , "price");
                deluxePrice = Integer.parseInt(deluxePriceVal.getText());
                JTextField suitePriceVal = (JTextField) env.FindComponents(suitePanel , "price");
                suitePrice = Integer.parseInt(suitePriceVal.getText());
    ...
    public JPanel RoomType(String roomType, String tfName) {
        ...
        typeLabel.setBounds(12, 10, 100, 15);
